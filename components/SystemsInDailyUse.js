...
const PROJECTS = [
  ...
  },
  {
    ...
    titleLines: ['One shared', 'picture.'],
    sub: 'Talent & hiring ops',
    note: 'The unified talent operations dashboard connecting candidates directly with teams.',
    bg: LINEN_SAND,
    ink: INK_DARK,
    accent: GOLD_ACCENT,
    outcomeLabel: 'RECRUITMENT IMPACT',
    outcomeVal: 'Instant Client-Side Search · Zero Latency Apply',
    tags: ['Next.js', 'Node.js', 'MongoDB', 'REST API'],
    url: 'https://apply-bureau.vercel.app/',
    description:
      'A modern job platform connecting ambitious talent directly with top hiring teams. Features live application tracking, candidate portfolios, and real-time dashboard analytics.',
  },
  {
    motif: 'shipping',
    num: '04',
